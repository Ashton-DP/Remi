...
import {
  ...
  handleGrowth, handleDecideGrowth, handleUpdateGrowthSettings, handleRewardReferral,
} from './routes/api';
...
app.post('/api/growth/referrals/:id/reward', requireApiAuth, handleRewardReferral);
